// File: ViewComponents/PassengerSidebarViewComponent.cs
using Microsoft.AspNetCore.Mvc;
using System.Net;
using System.Text.Json;
using RideShareConnect.Models;

public class PassengerSidebarViewComponent : ViewComponent
{
    private readonly HttpClient _httpClient;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public PassengerSidebarViewComponent(IHttpClientFactory httpClientFactory, IHttpContextAccessor httpContextAccessor)
    {
     ...
     public async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        return View(new UserProfileViewModel { FirstName = "Passenger", LastName = "", ProfilePicture = null });
    }
}
